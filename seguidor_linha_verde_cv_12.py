...
while True:
    ...
    if contours_green:
        ...
        if len(centros_verdes) == 2:
            #if interssecao == True: #lógica para anular dois verdes caso haja interseção
                #dir = "Verde anulado"
            #elif interssecao == False: 
                dir = "Dois verdes"
        ...
        cv2.putText(frame, f" Ang: {anglev:.1f}", (20,120),cv2.FONT_HERSHEY_COMPLEX, 0.7, (0,0,0), 1)
